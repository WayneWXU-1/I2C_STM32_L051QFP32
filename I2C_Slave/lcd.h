...
//|ODR7|ODR6|ODR5|ODR4|ODR3|ODR2|ODR1|ODR0 32 bits bit 16 bit usable any high
//| PA7|PA6 |PA5 |PA4 |PA3 |PA2 |PA1 |PA0| each ODR controls one port in that specific GPIO struct
